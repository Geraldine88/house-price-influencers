...
3. Review the material on the [Adobe Regression Challenge]()
...
- At least one successful prediction submission on [DSI-US-11 Regression Challenge]() --  you should see your name in the "[Leaderboard]()" tab.
- Data files
- Presentation slides
